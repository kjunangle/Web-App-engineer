...
$(document).ready(function() {
    ...
    success: function(data) {
                    ...
                    for(var i=0; i<data.production_companies.length;i++){
                         ...
                         $("#tbody").append("<div class='thumbnail'><div class='container'><div class='row test123'><div class='col-md-3 test123'><h4>"+getUrlParameter('id')+"</h4><img src=http://image.tmdb.org/t/p/w500/"+data.backdrop_path+" class='img-responsive'></div><div class='col-md-4 test123'> <p>"+data.overview+"</p><h4>Product by:</h4><p>"+company+"</p><h4>Rating</h4><p>"+data.vote_average+"</p></div><div class='col-md-5 test123' id='trailer2'></div></div></div></div>");
