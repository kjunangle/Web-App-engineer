...
<html lang="en">
      ...
      <ul class="nav navbar-nav">
        ...
        <li class="active" ><a href="add_product.php">Add Product </a></li>
           ...
           <div class="container-fluid">
              ...
              <form method="get" action="process.php" id="add_product" onsubmit="return Validate()">
               <div class="row">
  ...
  <div class="col-md-3"><input type="text" name="price" class="form-control"/></div><div class="col-md-1">THB</div>
 </div>   <br>
                              <div class="row">
                   <div class="col-md-1"></div>
  ...
  <div class="col-md-3"><input type="text" name="image" class="form-control" placeholder="eg img/product.img"/></div>
 </div>    
                  <br>
                  <div class="row">
                      
                       <div class="col-md-3"></div>
                    <div class="col-md-2"><input class="btn btn-default" value="ADD !" name="add_product" id ="addbutton" type="submit"/></div>
